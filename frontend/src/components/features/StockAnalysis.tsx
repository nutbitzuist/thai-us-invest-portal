    ...
    return (
        <div className="flex flex-col gap-6">
            ...
            <BrutalCard className="p-6 md:p-8 min-h-[400px] border-t-0 rounded-tl-none">
                {activeTab === 'analysis' && (
                    <div className="font-thai text-black text-lg">
                        {analysis ? (
                            <>
                                <h2 className="text-3xl font-bold mb-6 font-heading">{analysis.title_th || analysis.title}</h2>
                                <div className="prose prose-lg max-w-none prose-headings:font-heading prose-headings:font-bold prose-headings:mt-8 prose-h3:text-2xl prose-p:mb-4 prose-p:leading-relaxed prose-li:my-1 prose-strong:text-black">
